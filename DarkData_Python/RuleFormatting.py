...
def formatRules(filename,outputfile):
    f = open(filename, 'r')
    ...
    var = ['Processing_Level1','Processing_Level2','Measurement1','Measurement2','Instrument1','Instrument2','Time_Interval1','Time_Interval2','Spatial_Resolution1','Spatial_Resolution2','Hurricane','VolcanicEruption','Fire','Flood','Service']
